...
namespace AnalysisTool
{
    public class UPSRates
    {
        ...
        public decimal NDA(string table, string zone, string weight)
        {
        ...
        public decimal NDAS(string table, string zone, string weight)
        {
            if (!string.IsNullOrEmpty(table) && !string.IsNullOrEmpty(zone) && !string.IsNullOrEmpty(weight))
            {
                return Query(table, zone, weight);
        ...
        public decimal SDA(string table, string zone, string weight)
        {
            if (!string.IsNullOrEmpty(table) && !string.IsNullOrEmpty(zone) && !string.IsNullOrEmpty(weight))
            {
                return Query(table, zone, weight);
        ...
        public decimal TDS(string table, string zone, string weight)
        {
            if (!string.IsNullOrEmpty(table) && !string.IsNullOrEmpty(zone) && !string.IsNullOrEmpty(weight))
            {
                return Query(table, zone, weight);
